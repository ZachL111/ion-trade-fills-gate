...
`ion-trade-fills-gate` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for fills systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 165. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
